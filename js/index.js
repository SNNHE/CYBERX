$(function () {
  ...
  let pageRender = (function () {
    ...
    function load3DSwiper() {
      let swiper3D = new Swiper('#industryBanner .swiper-container', {
        ...
        onProgress: function (swiper, progress) {
          ...
          for (i = 0; i < swiper.slides.length; i++) {
            ...
            translate = slideProgress * modify * 337.5 + 'px';
    ...
    function loadEarth() {
      ...
      scene.add(light);
      let texture = new THREE.TextureLoader().load("images/outerloop.png");
      ...
      let textureW = new THREE.TextureLoader().load("images/earthloop.png");
